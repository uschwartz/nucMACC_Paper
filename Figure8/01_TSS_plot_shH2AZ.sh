...
genomINFO="/home/$USER/nucMACC_Paper/data/GRCh38/chrom_Sizes.txt"
...
bw=$AnalysisDir/RUN/01_MONO-NUCS_PROFILE
...
# hypo and hypo accessible nucleosomes

mono=$AnalysisDir/RUN/05_nucMACC/
...
# sub-nuc MACC
sub=$AnalysisDir/RUN/06_sub-nucMACC/
