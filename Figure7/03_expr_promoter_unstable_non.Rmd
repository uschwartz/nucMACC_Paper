...
work.path <- "~/Analysis/MNase_Yeast/scripts/Rscripts/Figures/Fig4/"
...
#get fragment sizes
#input
input<-read.delim("../../../../../MNase_Yeast/H4_IP/results/RUN/10_sub-nucMACC/sub-nucMACC_result_table.tsv")
TSS.gr <-import.bed("../../../../../MNase_Yeast/annotation/Yeast_TSS.bed")
TSS <-read.delim("../../../../../MNase_Yeast/annotation/Yeast_TSS.bed", header=FALSE)
TPM<-read.delim("../../../../..//MNase_Yeast/annotation/TPM_expr_strength.txt")

#Subsetting TSS according strand orientation
...
#Percentage of overlappe with +1 nuc
...
write.table(TPM.feat.flt, file="../../annotation/Mastertable_overlapping.txt", quote = FALSE)
```