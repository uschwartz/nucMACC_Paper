...
params.outDir="/Users/admin/Analysis/R001_nucMacc/manuscript_figures/Fig6/heatShock_SAGA/"
params.inputDir="/Users/admin/Analysis/R001_nucMacc/manuscript_figures/Fig6/data/heatShock_SAGA/*.bw"
...
input:
 tuple val(gene),val(rep),file(input)
 file(TSS)
...
computeMatrix(input.groupTuple(), TSS.collect())
