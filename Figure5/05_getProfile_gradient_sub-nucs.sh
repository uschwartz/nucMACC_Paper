...
DataDir=$AnalysisDir"/manuscript_figures/Fig5/ChIP_atlas/data"

cd $OutDir/data
mkdir sub-nucMACC_coverage

# positions of unstable nucleosomes
unstable=$AnalysisDir/H4_ChIP/RUN/10_sub-nucMACC/unStable_subNucs.bed
...
# positions of nonCanonical nucleosomes
noncan=$AnalysisDir/H4_ChIP/RUN/10_sub-nucMACC/nonCanonical_subNucs.bed
...
# bigwigs for sub-nucleosomes
H4bw=$AnalysisDir/H4_ChIP/RUN/06_SUB-NUCS_PROFILE/
...
/home/tools/UCSC/liftOver $DataDir"/ZKSCAN3/GSE149116_ZKSCAN3_S2_peaks.bed" \
