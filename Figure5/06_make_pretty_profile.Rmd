---
title: "make pretty profile subNucs TF"
author: "Uwe Schwartz"
date: "17/03/2022"
...
pdf("profile_zkscan3_subNucs.pdf", width = 5, height=4)
    par(mar=c(5.1, 4.1, 4.1, 7.1))
    plot(pos,
         smoothData(pos, zkscan3[H4.1.5,profile.index ]), 
         type="l", 
         xlab="distance from peak center", ylab = "MNase fragment density",
         lwd=2, main="ZSCAN3", col="#800026", ylim=c(60,200))
    lines(pos,
...
pdf("profile_msl1_subNucs.pdf", width = 5, height=4)
    par(mar=c(5.1, 4.1, 4.1, 7.1))
    plot(pos,
         smoothData(pos, msl1[H4.1.5,profile.index ]), 
         type="l", 
         xlab="distance from peak center", ylab = "MNase fragment density",
         lwd=2, main="MSL-1", col="#800026", ylim=c(60,120))
    lines(pos,
