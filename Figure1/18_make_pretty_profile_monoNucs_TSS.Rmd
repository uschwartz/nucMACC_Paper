---
title: "make pretty profile monoNucs TSS"
author: "Uwe Schwartz"
date: "06/12/2021"
...
USER<-Sys.info()["user"]
work.path<- paste0("/home/",USER,"/nucMACC_Paper/R001_nucMacc/manuscript_figures/Fig1/profiles//monoNucs_TSS_profile/")
...
TSS.pos<-which(colnames(heat.val.h4)=="tick")
...
#prepare plot
TSS.pos<-which(colnames(heat.val.h3)=="tick")
...
pdf("profile_H3_monoNucs.pdf", width = 5, height=4)
    par(mar=c(5.1, 4.1, 4.1, 7.1))
    plot(pos,
         heat.val.h3[H3.1.5,profile.index ], 
         type="l", 
         xlab="distance from TSS", ylab = "MNase fragment density",
         lwd=2, main="H3 mono-nucs", col="#6E016B", ylim=c(40,250))
    lines(pos,
