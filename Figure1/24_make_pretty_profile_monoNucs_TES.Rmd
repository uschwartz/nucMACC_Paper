---
title: "make pretty profile monoNucs TES"
author: "Uwe Schwartz"
date: "06/12/2021"
...
USER<-Sys.info()["user"]
work.path<- paste0("/home/",USER,"/nucMACC_Paper/R001_nucMacc/manuscript_figures/Fig1/profiles/monoNucs_TES_profile/)
...
pdf("profile_H4_monoNucs.pdf", width = 5, height=4)
    ...
    plot(pos,
         ...
         lwd=2, main="H4 mono-nucs", col="#6E016B", ylim=c(0,150))
    lines(pos,
...
pdf("profile_H3_monoNucs.pdf", width = 5, height=4)
    ...
    plot(pos,
         ...
         type="l", 
         xlab="distance from TES", ylab = "MNase fragment density",
         lwd=2, main="H3 mono-nucs", col="#6E016B", ylim=c(0,150))
    lines(pos,
