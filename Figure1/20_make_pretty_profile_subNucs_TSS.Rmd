---
title: "make pretty profile subNucs TSS"
author: "Uwe Schwartz"
date: "07/12/2021"
...
USER<-Sys.info()["user"]
work.path<- paste0("/home/",USER,"/nucMACC_Paper/R001_nucMacc/manuscript_figures/Fig1/profiles/subNucs_TSS_profile/")
...
pdf("profile_H4_subNucs.pdf", width = 5, height=4)
    ...
    plot(pos,
         ...
         lwd=2, main="H4 sub-nucs", col="#800026", ylim=c(40,250))
    lines(pos,
...
pdf("profile_H3_subNucs.pdf", width = 5, height=4)
    ...
    plot(pos,
         ...
         type="l", 
         xlab="distance from TSS", ylab = "MNase fragment density",
         lwd=2, main="H3 sub-nucs", col="#800026", ylim=c(40,250))
    lines(pos,
